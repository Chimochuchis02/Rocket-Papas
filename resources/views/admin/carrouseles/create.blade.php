            ...
            <div
                ...
                <form action="{{ route('carrouseles.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="flex flex-col">
                        <label for="nombre" class="font-semibold mb-1">Titulo Del Producto*:</label>
                        <input type="text" name="titulo" id="titulo" value="{{ old('titulo') }}"
                            class="rounded-md border-gray-300 dark:bg-gray-700 text-black dark:text-white" required />
                    </div>

                    <div class="flex flex-col">
                        <label for="nombre" class="font-semibold mb-1">Titulo De La Tarjeta*:</label>
                    ...
                    <div class="flex flex-col">
                        <label for="image_path" class="font-semibold mb-1">Imagen del Producto (Opcional):</label>
                    ...
                    <div class="flex flex-col">
                        <label for="image_path" class="font-semibold mb-1">Imagen modelo 3D (Opcional):</label>
